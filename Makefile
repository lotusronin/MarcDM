...
# Project:  marcdm.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile marcdm.pro
#############################################################################
...
CXXFLAGS      = -pipe -O2 -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong --param=ssp-buffer-size=4 -std=c++0x -Wall -W -D_REENTRANT -fPIC $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = marcdm1.0.0
DISTDIR = /home/marcus/Programming/qt\ dm/.tmp/marcdm1.0.0
LINK          = g++
...
distdir: FORCE
	...
	$(COPY_FILE) --parents main.cpp window.cpp server.cpp session.cpp settings.cpp auth.cpp $(DISTDIR)/
